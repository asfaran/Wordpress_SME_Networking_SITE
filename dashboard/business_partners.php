<?php
/*
  Template Name: Private Business Partners
 */
define('PRIVATE_SUBMENU', true, true);
define('SUBMENU_ITEM', 'business_partners');
define('DIRECTORY', 'BIZ_PARTNER', true);
...
$BP_Company_Filter->bool_biz_need_partner_in = true;

if (isset($_POST['filter_biz_partner'])) {
...
//var_dump($BP_Company_Filter);

biz_portal_add_visit(BP_VisitPageType::CUSTOM_PAGE, BP_CustomPage::BUSINESS_PARTNER);
            	...
            	<div>
                    ...
                    <div class="margin-bottom-20 margin-top-20" style="border-top:#dedede 1px solid;display:block">
                        ...
                        <div>
                       		...
                       		<form id="form_filter" action="<?php echo site_url('dashboard/list/business-partners'); ?>" method="post">
                       		    <input type="hidden" value="1" name="filter_biz_partner" />
                                    <ul>
                                        <li><a href="<?php echo site_url('dashboard/list/business-partners'); ?>">All</a></li>
                                           ...
                                           <div class="dropdown-menu extended notification" style="padding:0 0 10px 10px;">
                                               ...
                                               <div >
                                                    	<div class="form-group">
                                                          ...
                                                          <?php if ($type['id'] > 0) :?>
                                                             <label>
                                                             	<input type="checkbox" name="filter_partner_type_business[]" value="<?php echo $type['id']; ?>" <?php echo in_array($type['id'], $BP_Company_Filter->partner_in_typeof_businesses ) ? 'checked="checked"' : ''; ?>> <?php echo $type['type_text']; ?>
                                                             </label>
                                                          <?php endif; ?>
                                                          <?php endforeach; ?>
                                                          </div>
                                        ...
                                        <li class="dropdown list_sub_menu" id="industry_form">
                                        	<a href="#" class="dropdown-toggle"  data-hover="dropdown" data-close-others="true">Type of Industry</a>
                        					<div class="dropdown-menu extended notification" style="padding:0 0 10px 10px;">
                                               ...
                                               <div >
                                                    	<div class="form-group">
                                                          ...
                                                          <?php if ($industry['id'] > 0) :?>
                                                             <label>
                                                             	<input type="checkbox" name="filter_partner_industry[]" value="<?php echo $industry['id']; ?>" <?php echo in_array($industry['id'], $BP_Company_Filter->partner_in_industries ) ? 'checked="checked"' : ''; ?>> <?php echo $industry['ind_name']?>
                                                             </label>
                                                          <?php endif; ?>
                                                          <?php endforeach;?>
                                                          </div>
                    ...
                    <div class="col-md-8">
                       ...
                       <?php else : ?>
                           <?php 
                            ...
                            ?>
                            &nbsp;<br />
                            <div data-location="<?php echo $edit_location; ?>" data-id="content_biz_partner_nocontent" class="<?php echo $edit_class; ?>">
                            <?php echo get_option('content_biz_partner_nocontent', 'No listing found.') ?></div>
                       <?php endif;  ?> 
