...
function register_custom_settings() // whitelist options
{
    ...
    register_setting('custom_website_settings', 'about_page_row_one');
    register_setting('custom_website_settings', 'about_page_row_two');
    register_setting('custom_website_settings', 'about_page_row_three');
    
    register_setting('custom_website_settings', 'ads_page_row_one');
    register_setting('custom_website_settings', 'ads_page_row_two');
    register_setting('custom_website_settings', 'ads_page_row_three');
...
function plugin_options_page()
{
    ...
    <div class="wrap">
        ...
        <?php do_settings_sections('custom_website_settings'); ?>
            ...
            <a class="nav-tab<?php echo $class; ?>" href="?page=plugin&tab=option">About Page Option</a>
            <?php $class_v = ( "ads" === $current ) ? '' : ' hidden'; ?>
            <a class="nav-tab<?php echo $class; ?>" href="?page=plugin&tab=ads">Ads Page Option</a>
