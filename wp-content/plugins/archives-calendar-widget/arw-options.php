...
function archives_calendar_settings(){?>
	...
	<h2><?php _e('Archives Calendar Settings', 'arwloc');?></h2>
			...
			<div id="post-body-content">
				...
				<div id="ac_preview" style="display:none;">
					...
					<strong><?php _e('Theme');?>:</strong> <select id="themepreview">
						<option <?php selected( 'default', $theme ); ?> value="default"><?php _e('Default', 'arwloc'); ?></option>
						<option <?php selected( 'classiclight', $theme ); ?> value="classiclight">Classic</option>
						...
						<option <?php selected( 'twentyfourteen', $theme ); ?> value="twentyfourteen">Twenty Fourteen</option>
						<!--<option <?php selected( 'custom', $theme ); ?> value="custom"><?php _e('Custom', 'arwloc');?></option>-->
			...
			if($('html').data('arctimer'))
				...
				<p>
					...
					<div id="ac_default_code" style="display:none;">
						<h2 class="title">$.archivesCW default parameters: <a class="button-primary" style="height: 20px; line-height: 16px;" href="<?php echo plugins_url( 'archives-calendar-widget/default.js.txt' , dirname(__FILE__) ); ?>" target="_blank"><?php _e('Open'); ?> .txt</a></h2>
						<pre>
<?php include 'default.js.txt'; ?>
						</pre>
					</div>
				</p>
				<hr />
				<p>
					...
					<pre>[arcalendar next_text=">" prev_text="<" post_count="true"]</pre>
				</p>
				<hr />
				<p>
				...
				<hr />
				<p>
					<input name="Submit" type="submit" style="margin:20px 0;" class="button-primary" value="<?php _e('Save Changes', 'arwloc') ?>" />
				</p>
			</div>
			<div id="postbox-container-1" class="postbox-container">
				...
				<div class="postbox">
					<div class="inside" style="padding:15px;">
						...
						?>
						<h2 style="font-size:24px; margin:0;"><?php _e('Also', 'arwloc');?></h2>
						<h4>
							<strong><?php _e('My other projects on ', 'arwloc');?></strong>
						</h4>
						<p>
						...
						<h4>
							<strong><?php _e('My portfolio:', 'arwloc');?></strong>
						</h4>
						<p>
