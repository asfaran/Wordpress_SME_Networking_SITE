...
function add_loginout_link( $items, $args ) {
    global $login_box_args;
	
    if (is_user_logged_in() && $args->theme_location == 'primary') {
        $items = '<li><a id="bttn_login" href="#">Log Out</a></li>' . $items;
    }
    elseif (!is_user_logged_in() && $args->theme_location == 'primary') {
        $items = '<li>' . wp_login_form( $login_box_args ) . '<a id="bttn_login" href="#">Log In</a></li>' . $items;
    }
    return $items;
}
