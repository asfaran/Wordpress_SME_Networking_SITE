            ...
            <div class="col-md-4  login-signup-page">
                ...
                <div style="padding:0 ; background-color:#f3f3f3;" >
                    <p style="margin:0 20px 30px; padding-top:20px;">
                    	...
                    	<?php if (!empty($error)) :?>
                    	<br />
                    	<span style="position:abosolute;float:left;color:red;font-size:12px;"><?php echo $error; ?></span>
                    	<?php endif; ?>
                    </p>
                    ...
                    <div style="background-color:#d5dddf; height:100px; width:100%; clear:both; vertical-align:middle; margin-top:-10px; z-index:1; position:relative">
                            ...
                            <p style="text-align:center; padding-top:60px; color:#444; z-index:100;"><a href="<?php echo site_url('wp-login.php') . '?action=lostpassword' ?>" style="color:#444; text-decoration:none">Forgot Password</a> | <a href="#" style="color:#444; text-decoration:none" onclick="$('#login_register_box').toggle();">Register</a></p>                      
    ...
    <script type="text/javascript">
        jQuery(document).ready(function() {    
		  ...
		  // $('.login-password').addClass('input-group margin-bottom-40');
		   ...
		   //var image = new Image();
		   //image.src = '<?php echo $img_url . '&w=2000&h=2000&prog=1'; ?>';
