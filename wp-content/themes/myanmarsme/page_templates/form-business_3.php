										...
										<ul class="nav nav-pills nav-justified steps">
											...
											<li>
												...
												if($mtype == "TYPE_SME")
													...
													if($mtype == "TYPE_INTL")
														echo "Business Related";
													else
														echo "Organizational Type";
												}
												//echo ($mtype == "TYPE_SME") ? "Looking For ...": ($mtype == "TYPE_INTL") ? "General Info":"Organizational Type";  ?> 
                                                </span>   
												</a>
											</li>
											<li>
                                                ...
                                                <?php echo ($mtype == "TYPE_NGO") ? "Provide Services": "Looking To ..."; ?>
										...
										<div class="tab-content">
                                           ...
                                           <?php endif;  ?>
											...
											<div class="tab-pane" id="tab2">
                                                ...
                                                <div class="col-md-4">
                                                        ...
                                                        <div class="panel panel-info">
                                                                <div class="panel-heading"><h3 class="panel-title"><input type="checkbox" name="biz_need_partner" value="1" data-title="Partner in"  <?php echo (isset($BP_Company_Full->bool_biz_need_partner_in)) ? "checked='checked'":""; ?> > Partner(s) </h3></div>
                                                         	...
                                                         	<div class="panel panel-info">
                                                                <div class="panel-heading">
                                                                	<h3 class="panel-title">
                                                                    	<input type="checkbox" name="biz_need_invest" value="1" data-title="Investors" <?php echo (isset($BP_Company_Full->bool_biz_need_invest)) ? "checked='checked'":""; ?>> Investors 
                                                                    </h3>
                                                                </div>
                                                                <div class="panel-body">
                                                ...
                                                <div class="col-md-4" >
															...
															<div class="panel panel-info">
                                                                <div class="panel-heading"><h3 class="panel-title"><input type="checkbox" name="biz_needs_service_provide_bool" value="1" data-title="Service Provider" <?php echo (isset($BP_Company_Full->bool_biz_need_service)) ? "checked='checked'":""; ?> > Service Providers </h3></div>
                                                                <div class="panel-body">                                                            	
                                            ...
                                            <div class="row">
                                                ...
                                                <?php endif;  ?> <!----  (INTL) Business Related Info  -->
...
<!------------  Invest   ------------->
                                                         <div class="col-md-4">
                                                         	<div class="panel panel-info">
                                                                <div class="panel-heading">
                                                                	<h3 class="panel-title">
                                                                    	<input type="checkbox" name="biz_give_invest" value="1" data-title="Investors" <?php echo (isset($BP_Company_Full->bool_biz_give_invest)) ? "checked='checked'":""; ?>> Investment 
                                                                    </h3>
                                                                </div>
                                                                <div class="panel-body">
                                                        ...
                                                        <?php if($mtype == "TYPE_NGO"):  ?>
                                                        <h4 class="well well-sm">Provide Services</h4>
                                                        <div class="row">
