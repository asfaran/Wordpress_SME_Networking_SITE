									...
									<div class="form-body margin-bottom-40">
										<ul class="nav nav-pills nav-justified steps">
											<li>
												...
												<span class="desc"><i class="fa fa-check"></i> General <br />Information</span>   
												</a>
											</li>
                                            ...
                                            <li>
												...
												<span class="desc"><i class="fa fa-check"></i> Opportunity<br />Looking For </span>   
												</a>
											</li>
                                            <?php endif; ?>
											<li>
                                                ...
                                                <?php echo ($mtype == "TYPE_NGO") ? "Services<br> Offered": "Opportunity<br />Looking To "; ?>
											...
											<li>
												...
												<span class="desc"><i class="fa fa-check"></i> Other<br />Questions</span>   
												</a> 
											</li>
                                            <li>
												<a href="#tab5" data-toggle="tab" class="step">
												<span class="number"><?php echo ($mtype == "TYPE_SME") ? "5":"4";  ?></span><br />
												<span class="desc"><i class="fa fa-check"></i> Detailed<br />Summary </span>   
												</a> 
											</li>
										</ul>
										...
										<div class="tab-content">
                                           ...
                                           <div class="clearfix"></div>
                                               ...
                                               <!------  row    (Business Related Information)   ------->
                                           ...
                                           <?php if($mtype == "TYPE_NGO"):  ?>
                                            <div class="clearfix"></div>
                                                    ...
                                                    <div class="col-md-12" >
                                                            ...
                                                            <textarea class="form-control" rows="3" name="summary"><?php echo isset($BP_Company_Full->summary) ? $BP_Company_Full->summary : "" ;  ?></textarea></span>
										...
										<!-- If Funding is Provided  -->
                                                	...
                                                	<div class="row">
                                                    	<div class="container">
                                                        	<div class="form-body">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                    	<div class="col-md-12">
                                                                        <label><?php echo $partner_label; ?></label><br />                                                             
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="col-md-12">
                                                                        <label>Looking for investors, please describe more details (maximum 150 words).</label><br />
                                                                    ...
                                                                    <div class="col-md-12">
                                                                    	<div class="col-md-12">
                                                                        <label>Looking for service providers, please describe more details. (maximum 150 words)</label><br />
                                                                    ...
                                                                    <div class="col-md-12">
                                                                    	<div class="col-md-12">
                                                                        <label><?php echo $invest_label; ?></label><br />
                                                                    ...
                                                                    <div class="col-md-12">
                                                                    	<div class="col-md-12">
                                                                        <label><?php echo $provide_services_label; ?></label><br />
                                                                    ...
                                                                    <?php if($mtype == "TYPE_NGO") {  ?>
                                                                     ...
                                                                     <div class="col-md-12">
                                                                     	<div class="col-md-12">
                                                                        <label>Please provide more details about the services and resources offered by your organization (maximum 350 words).</label><br />
											...
											<div class="tab-pane" id="tab5">
                                                ...
                                                <?php if(($mtype == "TYPE_SME") || ($mtype == "TYPE_INTL")){ ?>
                                                	...
                                                	<div class="form-group" id="question_partner">
                                                        <label class="control-label col-md-3">Looking for business partners:</label>
                                                        <div class="col-md-9">
                                                ...
                                                <?php if(($mtype == "TYPE_SME")){ ?>
                                                    ...
                                                    <div class="form-group" id="question_need_invest">
                                                    ...
                                                    <div class="form-group" id="question_need_sp">
                                                 ...
                                                 <?php }  ?>
                                                  ...
                                                  <?php if(($mtype == "TYPE_SME") || ($mtype == "TYPE_INTL")){ ?>
                                                    ...
                                                    <div class="form-group" id="question_give_invest">
                                                    ...
                                                    <div class="form-group" id="question_give_sp">
                                                ...
                                                <?php  if($mtype == "TYPE_NGO") { ?>
                                                	<div class="form-group" id="question_need_ngo">
