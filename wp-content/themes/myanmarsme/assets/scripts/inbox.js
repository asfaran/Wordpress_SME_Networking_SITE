var Inbox = function () {
    ...
    var initWysihtml5 = function () {
        $('.inbox-wysihtml5').wysihtml5({
            "stylesheets": [template_directory_uri + "assets/plugins/bootstrap-wysihtml5/wysiwyg-color.css"]
        });
    }
    ...
    var initFileupload = function () {
        ...
        $('#fileupload').fileupload({
            ...
            url: template_directory_uri + 'assets/plugins/jquery-file-upload/server/php/',
            autoUpload: true
        });
    ...
    return {
        ...
        init: function () {
            ...
            $('#inbox_search_btn').click(function () {
